...
TYPES = {
    ...
    CONF_BATTERY_UNDER_VOLTAGE: (
        [40.0, 41.0, 42, 43, 44, 45, 46, 47 ,47.5 ,48.0, 48.5],
        "PSDV%02.1f",
    ),
    ...
    CONF_CURRENT_MAX_AC_CHARGING_CURRENT: ([2, 10, 20, 30, 40, 50], "MUCHGC%04.0f"),
    CONF_CURRENT_MAX_CHARGING_CURRENT: ([10, 20, 30, 40, 50], "MCHGC%03.0f"),
